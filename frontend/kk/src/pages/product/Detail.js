...
import React, { useEffect, useState } from "react";
import { useSearchParams, useNavigate } from "react-router-dom"; // Import useNavigate để điều hướng
import { GET_ID } from "../../api/apiService";
import { useCart } from "../../context/CartProvider";
...
const Detail = () => {
  ...
  const handleAddToCart = () => {
    ...
    navigate("/cart"); // Điều hướng đến trang giỏ hàng sau khi thêm vào giỏ
  };
